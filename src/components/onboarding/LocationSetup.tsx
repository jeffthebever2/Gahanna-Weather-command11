  ...
  return (
    <div className="py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">We'll use this to provide accurate forecasts for your area</p>
      </div>
      ...
      <div className="flex justify-between">
        ...
        <Button type="button" onClick={handleManualLocation} className="bg-blue-600 hover:bg-blue-700">
          Continue
        </Button>
      </div>
    </div>
